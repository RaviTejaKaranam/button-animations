...
const ButtonHoverBackgroundChange = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{
          width: hovered ? "110%" : "100%", // Change width on hover
          left: hovered ? "0%" : "100%", // Slide in from the right
...
export default ButtonHoverBackgroundChange;
